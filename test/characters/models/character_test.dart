...
void main() {
  ...
  setUp(() {
    map = mock;
    character = Character.fromMap(map);
  });
  ...
  group('Character', () {
    test('fromMap', () {
      ...
      expect(character.comics, isA<List<String>>());
      expect(character.series, isA<List<String>>());
      expect(character.stories, isA<List<String>>());
      expect(character.events, isA<List<String>>());
    });
  });
}
